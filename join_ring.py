...
if __name__  == "__main__":
    ...
    "protoc --go_out=. --go-grpc_out=. proto/introducer.proto"
    ...
    join = "cd ~/mp2; go run initiator/client.go --join"
    if args.servers != None:        
        RunEachVM(cmd = join, servers=args.servers)
    else:
        RunEachVM(cmd = join, servers=list(range(1, 11)))
